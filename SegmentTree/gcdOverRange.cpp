    ...
    public:
        ...
        void build(vi &arr, ll left, ll right, ll pos = 1)
        {
            ...
            else
            {
                ...
                st[pos] = __gcd(st[pos << 1LL], st[(pos << 1LL) + 1]);
            }
        }

        ll gcd(ll l, ll r, ll left, ll right, ll pos = 1)
        {
            if (l > r)
                return 0;
            if (l == left && r == right)
            ...
            ll mid = (left + right) / 2;
            return __gcd(gcd(l, min(r, mid), left, mid, pos << 1LL), gcd(max(mid + 1, l), r, mid + 1, right, (pos << 1LL) + 1));
        }
